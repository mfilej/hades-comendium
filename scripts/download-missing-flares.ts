...
async function downloadAndSaveImage(imageUrl, alt, god, boonName) {
  try {
    ...
    const filename = `${god}_${sanitizedBoonName}_i.${
    ...
    if (boon.length > 0) {
      ...
      const updatedHtml = boonHtml.replace(
        /<img[^>]*>/g,
        `<img src="/${localPath}" alt="${alt || boonName}">`,
      );
...
const flareData = [
  {
    ...
    sourceUrl:
      "https://static.wikia.nocookie.net/hades_gamepedia_en/images/7/7d/True_Shot_I.png/revision/latest/scale-to-width-down/100?cb=20240604204328",
  ...
  },
  {
    ...
    sourceUrl:
      "https://static.wikia.nocookie.net/hades_gamepedia_en/images/0/0f/Flood_Shot_I.png/revision/latest/scale-to-width-down/100?cb=20240604204327",
    alt: "Flood Flare I",
  },
  {
    god: "zeus",
    ...
    sourceUrl:
      "https://static.wikia.nocookie.net/hades_gamepedia_en/images/8/83/Electric_Shot_I.png/revision/latest/scale-to-width-down/100?cb=20240604204327",
    alt: "Thunder Flare I",
  },
  {
    god: "dionysus",
    ...
    sourceUrl:
      "https://static.wikia.nocookie.net/hades_gamepedia_en/images/7/7d/Trippy_Shot_I.png/revision/latest/scale-to-width-down/100?cb=20240604204328",
    alt: "Trippy Flare I",
  },
  {
    god: "demeter",
    boonName: "Icy Flare",
    sourceUrl:
      "https://static.wikia.nocookie.net/hades_gamepedia_en/images/c/c1/Crystal_Beam_I.png/revision/latest/scale-to-width-down/100?cb=20240604204327",
    alt: "Icy Flare I",
  },
  {
    god: "aphrodite",
    ...
    sourceUrl:
      "https://static.wikia.nocookie.net/hades_gamepedia_en/images/2/2f/Crush_Shot_I.png/revision/latest/scale-to-width-down/100?cb=20240604204327",
    alt: "Passion Flare I",
  },
  {
    god: "ares",
    ...
    sourceUrl:
      "https://static.wikia.nocookie.net/hades_gamepedia_en/images/2/2b/Slicing_Shot_I.png/revision/latest/scale-to-width-down/100?cb=20240604204328",
    alt: "Slicing Flare I",
  },
  {
    god: "athena",
    ...
    sourceUrl:
      "https://static.wikia.nocookie.net/hades_gamepedia_en/images/a/a8/Phalanx_Shot_I.png/revision/latest/scale-to-width-down/100?cb=20240604204327",
    alt: "Phalanx Flare I",
  },
];
...
let downloadCount = 0;
console.log(
  `Attempting to download ${flareData.length} missing Flare images...`,
);
